...
! defined( 'WOOSC_VERSION' ) && define( 'WOOSC_VERSION', '5.1.7' );
			...
			class WPCleverWoosc {
				...
				function enqueue_scripts() {
					...
					wp_localize_script( 'woosc-frontend', 'woosc_vars', array(
							...
							'open_bar'           => get_option( 'woosc_open_bar_immediately', 'no' ),
							'bar_bubble'         => get_option( 'woosc_bar_bubble', 'no' ),
							'adding'             => get_option( 'woosc_adding', 'prepend' ),
							'click_again'        => get_option( 'woosc_click_again', 'no' ),
				...
				function register_settings() {
					// settings
					register_setting( 'woosc_settings', 'woosc_adding' );
                                ...
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="woosc_adding">
                                                    <option value="prepend" <?php echo esc_attr( get_option( 'woosc_adding', 'prepend' ) === 'prepend' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Prepend', 'woo-smart-compare' ); ?>
                                                    </option>
                                                    <option value="append" <?php echo esc_attr( get_option( 'woosc_adding', 'prepend' ) === 'append' ? 'selected' : '' ); ?>>
														<?php esc_html_e( 'Append', 'woo-smart-compare' ); ?>
                                                    </option>
                                                </select>
